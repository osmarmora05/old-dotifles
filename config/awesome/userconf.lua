...
user.battery      = true
user.battery_name = "battery_BAT1"
...
user.brightness_name = "amdgpu_bl1"
...
user.inner_gaps   = 0.4
user.outer_gaps   = user.inner_gaps * 1.7 -- Triple outer gap.
...
--user.avatar       = os.getenv("HOME") .. "/Documentos/everblush/user.png"
--- Your wallpaper path. Path, or comment for colorscheme default.
--user.wall         = os.getenv("HOME") .. "/Documentos/everblush/wall.png"
--- Music player fallback background. Path, or comment for colorscheme default.
--user.player_bg    = os.getenv("HOME") .. "/Documentos/everblush/player.png"
