...
local function Get_icon(client, program_string, class_string, is_steam)
  ...
  if (client or program_string or class_string) then
    ...
    elseif client then
      ...
      elseif client.name then
        ...
        if client.icon then
          ...
          return "/usr/share/icons/WhiteSur/apps/scalable/default-application.svg"
        end
      end
    else
    ...
    local iconDir = "/usr/share/icons/WhiteSur/apps/scalable/"
    ...
    if ioStream ~= nil then
      ...
      iconDir = "/usr/share/icons/WhiteSur/apps/scalable/"
