...
if beautiful.bar_gap then
    ...
    screen.mywibox.margins = {
        right   = beautiful.bar_side == "right" and dpi(5) or 0,
        left    = beautiful.bar_side == "left" and dpi(5) or 0,
        bottom  = beautiful.bar_side == "bottom" and dpi(5) or 0,
        top     = beautiful.bar_side == "top" and dpi(5) or 0
    }
end
